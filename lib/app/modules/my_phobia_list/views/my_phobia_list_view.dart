...
class MyPhobiaListView extends GetView<MyPhobiaListController> {
  const MyPhobiaListView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        final diaryPhobiaState = controller.diaryPhobiaState.value;
        final addDiaryPhobiaListState =
            controller.addDiaryPhobiaListState.value;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SafeArea(
                  child: Center(
                    child: addDiaryPhobiaListState.when(
                      initial: () => CustomButton(
                        onTap: () {
                          FocusManager.instance.primaryFocus?.unfocus();
                          controller.addDiaryPhobiaList();
                        },
                        position: 4.0.obs,
